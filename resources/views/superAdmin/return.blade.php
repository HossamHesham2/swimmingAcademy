                                        ...
                                        @foreach ($members as $member)
                                            @if (in_array($member->state, ['قيد المعالجه', 'تم القبول', 'تم الرفض']))
                                                <tr>
                                                    ...
                                                    <td>
                                                        @if (in_array($member->state, ['قيد المعالجه']))
                                                            <a href="{{ route('superAdmin.accept', $member->id) }}"
                                                                class="btn btn btn-success">موافقه</a>
                                                            <a href="{{ route('superAdmin.cancel', $member->id) }}"
                                                                class="btn btn btn-danger">رفض</a>
                                                        @elseif($member->state == 'تم القبول')
                                                            <a href="{{ route('superAdmin.cancel', $member->id) }}"
                                                                class="btn btn btn-danger">رفض</a>
                                                        @elseif($member->state == 'تم الرفض')
                                                            <a href="{{ route('superAdmin.accept', $member->id) }}"
                                                                class="btn btn btn-success">موافقه</a>
                                                        @endif
                                                    </td>
